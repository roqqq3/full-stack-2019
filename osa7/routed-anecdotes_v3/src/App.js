...
const App = () => {
  ...
  const handleSetAddedAnecdote = () => {
    setAddedAnecdote(true)
    setNotification("a new anecdote " + anecdotes[anecdotes.length - 1].content + " created!")
    setTimeout(() => {
      setNotification('')
  ...
  return (
    <Router>
      <div>
        ...
        <Route exact path="/create" render={() => addedAnecdote ? <Redirect to="/" /> : <CreateNew handleSetAddedAnecdote={handleSetAddedAnecdote} addNew={addNew} />} />
